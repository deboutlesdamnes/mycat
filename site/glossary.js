...
(function () {
  ...
  const GLOSSARY = [
    ...
    { term: "Rate law",
      ...
      definition: "An experimentally determined equation relating reaction rate to reactant concentrations and a rate constant (rate = k[A]^m[B]^n); reaction orders are found by experiment, not from stoichiometry." },
    ...
    { term: "van der Waals equation",
      ...
      definition: "Corrects the ideal gas law for real gases — (P + an²/V²)(V − nb) = nRT — accounting for intermolecular attractions and finite molecular volume." },
